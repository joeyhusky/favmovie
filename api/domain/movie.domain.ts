export function toMovieDTO(data: MovieDTOFromMovieDb): MovieDTO {
  return {
    id: data.id,
    title: data.title,
    overview: data.overview,
    poster_path: data.poster_path,
    imdb_id: data.release_date,
...
export type MovieDTO = Pick<
  MovieDTOFromMovieDb,
  "id" | "title" | "poster_path" | "overview" | "tagline" | "imdb_id"
>;

export interface MovieDTOFromMovieDb {
  adult: boolean;
